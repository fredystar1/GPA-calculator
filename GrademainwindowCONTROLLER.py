...
class controller(QMainWindow, Ui_MainWindow):
    ...
    def score_finder(self) -> None:
        ...
        try:
            ...
            if score_average >= A:
                answers.append(f"your average score is {score_average} and GPA is an A")
            elif score_average >= B:
                answers.append(f"your average score is {score_average} and GPA is an B")
            elif score_average >= C:
                answers.append(f"your average score is {score_average} and GPA is an C")
            elif score_average >= D:
                answers.append(f"your average score is {score_average} and GPA is an D")
            else:
                answers.append(f"your average score is {score_average} and GPA is an F")
